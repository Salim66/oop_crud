...
<body>
	...
	<div class="wrap">
		...
		<div class="card shadow">
			...
			<div class="card-body">
				<img class="shadow" style="width: 200px; height: 200px; border-radius: 50%; display: block; margin: auto; border: 10px solid #fff;" src="media/img/Student/<?php echo $single_student['photo'] ?>" alt="">
